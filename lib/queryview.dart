...
import 'package:sql/queryresultview.dart';
...
class _QueryViewState extends State<QueryView> {
  ...
  void searchdb() async {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (BuildContext context) => QueryResultView(searchfieldname: dropdownValue, searchvalue: searchvalue,)));
  }
}
